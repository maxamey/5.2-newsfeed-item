      ...
      <main className="feedWrapper">
        <div className="itemWrapper">
          <section className="articleWrapper">
            <heading>
              <a href="#"
                 className="article__heading--authorProfileImageLink">
              ...
              <div className="article__heading--textContainer">
                <a href="#"
                   className="article__heading--authorProfileNameLink">
            ...
            <a href="#"
               className="article__preview--link">
              <img src="http://38.media.tumblr.com/e5b4235e328c50d0bfb446bb88186524/tumblr_inline_mm7j02WdMt1qikbwy.jpg"
            ...
            <footer className="article__footer">
              <span className="article__footer--likeButton">
                Like
              </span>
              <span className="article__footer--commentButton">
                Comment
              </span>
            </footer>
          </section>
